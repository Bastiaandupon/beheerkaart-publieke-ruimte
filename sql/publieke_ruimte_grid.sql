 ...
 * 
 */
drop table if exists "openbare_ruimte_CROW".publieke_ruimte_grid;
CREATE TABLE "openbare_ruimte_CROW".publieke_ruimte_grid as
(
select
	opr.id,
	opr.col,
	...
	opr.geometrie
from
	"openbare_ruimte_CROW".opr_grid as opr	
left join
...
order by opr.id asc
;
drop index if exists "openbare_ruimte_CROW".publieke_ruimte_grid_gindx;
CREATE INDEX publieke_ruimte_grid_gindx ON "openbare_ruimte_CROW".publieke_ruimte_grid USING GIST (geometrie);
vacuum analyze "openbare_ruimte_CROW".publieke_ruimte_grid;
