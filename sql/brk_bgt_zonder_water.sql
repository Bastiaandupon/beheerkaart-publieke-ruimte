 ...
 *  
 */
drop table if exists "openbare_ruimte_CROW".brk_bgt_zonder_water;
CREATE TABLE "openbare_ruimte_CROW".brk_bgt_zonder_water as
(select 
	sub.*
from(
		select
		...
		from
			"openbare_ruimte_CROW".bgt_zonder_water layer1
		join 
...
drop index if exists "openbare_ruimte_CROW".brk_bgt_zonder_water_gindx;
CREATE INDEX brk_bgt_zonder_water_gindx ON "openbare_ruimte_CROW".brk_bgt_zonder_water USING GIST (geometrie);

vacuum analyze "openbare_ruimte_CROW".brk_bgt_zonder_water;
