 ...
 *  
 */
drop table if exists "openbare_ruimte_CROW".brk_bgt_amsterdam;
CREATE TABLE "openbare_ruimte_CROW".brk_bgt_amsterdam as
(select 
	bgt_id,
	bkr_id,
	"type",
	...
	fractie
from 
	"openbare_ruimte_CROW".brk_bgt layer1
join 
...
drop index if exists "openbare_ruimte_CROW".brk_bgt_amsterdam_gindx;
CREATE INDEX brk_bgt_amsterdam_gindx ON "openbare_ruimte_CROW".brk_bgt_amsterdam USING GIST (geometrie);

vacuum analyze "openbare_ruimte_CROW".brk_bgt_amsterdam;
