/*
 * Waterdeel pre selectie waar:
 * 
 * fractie >= 0.6
 * 
 */
drop table if exists "openbare_ruimte_CROW".waterdeel_gt06;
create table "openbare_ruimte_CROW".waterdeel_gt06 as
(
select 
	agg.bgt_id,
	agg.bgt_type,
...
;
drop index if exists "openbare_ruimte_CROW".waterdeel_gt06_gindx;
CREATE INDEX waterdeel_gt06_gindx ON "openbare_ruimte_CROW".waterdeel_gt06 USING GIST (geometrie);
--
vacuum analyze "openbare_ruimte_CROW".waterdeel_gt06;
--
