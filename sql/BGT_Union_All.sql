 ...
 * 
 */
drop table if exists "openbare_ruimte_CROW".bgt_union_all;
create table "openbare_ruimte_CROW".bgt_union_all as
(select
	agg.bgt_id,
	agg."type",
	agg.nivo,
...
--
drop index if exists "openbare_ruimte_CROW".bgt_union_all_gindx;
CREATE index bgt_union_all_gindx on "openbare_ruimte_CROW".bgt_union_all USING GIST (geometrie);
--
vacuum analyze "openbare_ruimte_CROW".bgt_union_all;
--
-- Aanmaken metadata voor zichtbaarheid in QGIS
select Populate_Geometry_Columns('"openbare_ruimte_CROW".bgt_union_all'::regclass, true);
