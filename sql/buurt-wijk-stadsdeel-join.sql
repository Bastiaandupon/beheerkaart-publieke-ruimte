...
select 
	...
	ggw.id as gebiedsgerichtwerken_id,
	ggw.naam as gebiedsgerichtwerken_naam,
	ggw.code as gebiedsgerichtwerken_code,
	brt.stadsdeel_id,
...
left join
	bagdatapunt.bag_gebiedsgerichtwerken as ggw
on 
	brt.stadsdeel_id = ggw.stadsdeel_id
left join
